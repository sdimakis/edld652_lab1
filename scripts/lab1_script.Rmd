...
```{r plot1}
# I like the `geom_hline()` approach. If you wanted to do this through
# the theme settings, which is a bit more programmatic, you could use
...
ggplot(rstats, aes(x = fct_reorder(screen_name, n), y = n)) +
  ...
  theme(axis.line = element_blank(), 
        ...
        plot.subtitle = element_text(hjust = -0.35)) # adjusting title and subtitle location
```
